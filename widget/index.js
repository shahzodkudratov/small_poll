...
var s_p_w = {
  response: undefined,
  html: function html() {
    document.getElementById('small_poll_widget').insertAdjacentHTML('beforeend', "<div id=\"s_p_w_header\" onclick=\"s_p_w.toggle()\"><span><svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" aria-hidden=\"true\" focusable=\"false\" width=\"20px\" height=\"20px\" style=\"vertical-align: -0.143em;-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);\" preserveAspectRatio=\"xMidYMid meet\" viewBox=\"0 -256 1792 1792\"><path d=\"M640 640q0-53-37.5-90.5T512 512t-90.5 37.5T384 640t37.5 90.5T512 768t90.5-37.5T640 640zm384 0q0-53-37.5-90.5T896 512t-90.5 37.5T768 640t37.5 90.5T896 768t90.5-37.5T1024 640zm384 0q0-53-37.5-90.5T1280 512t-90.5 37.5T1152 640t37.5 90.5T1280 768t90.5-37.5T1408 640zm384 0q0 174-120 321.5t-326 233t-450 85.5q-110 0-211-18q-173 173-435 229q-52 10-86 13q-12 1-22-6t-13-18q-4-15 20-37q5-5 23.5-21.5T198 1398t23.5-25.5t24-31.5t20.5-37t20-48t14.5-57.5T313 1126q-146-90-229.5-216.5T0 640q0-174 120-321.5t326-233T896 0t450 85.5t326 233T1792 640z\" fill=\"white\"/></svg> <span>Join this poll</span></span><span id=\"s_p_w_arrow\"><svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" aria-hidden=\"true\" focusable=\"false\" width=\"15px\" height=\"20px\" style=\"-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);\" preserveAspectRatio=\"xMidYMid meet\" viewBox=\"0 0 1024 1280\"><path d=\"M1011 928q0 13-10 23l-50 50q-10 10-23 10t-23-10L512 608l-393 393q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l466-466q10-10 23-10t23 10l466 466q10 10 10 23z\" fill=\"white\"/></svg></span></div><div id=\"s_p_w_body\"><form id=\"s_p_w_poll\" name=\"s_p_w_poll\"></form><div id=\"s_p_w_buttons\"><button id=\"s_p_w_next\" onclick=\"s_p_w.next()\">Next</button></div></div><style>#small_poll_widget{position:fixed;bottom:-100px;right:0;z-index:9999;background:#232323;color:#fff;border-top-left-radius:16px;border-top-right-radius:16px;width:350px;transition:all .5s;font-family:Avenir,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}#small_poll_widget.s_p_w_loaded{bottom:0}#small_poll_widget #s_p_w_header{background:#222c28;padding:15px 25px;border-top-left-radius:16px;border-top-right-radius:16px;display:flex;justify-content:space-between;align-items:center;cursor:pointer}#small_poll_widget #s_p_w_header span span{margin-left:6px}#small_poll_widget #s_p_w_body{overflow:hidden;max-height:0;transition:all .5s}#small_poll_widget #s_p_w_arrow{transition:all .2s}#small_poll_widget.s_p_w_show #s_p_w_arrow{transform:rotate(180deg) translateY(-2px)}#small_poll_widget.s_p_w_show #s_p_w_body{position:relative;left:0;max-height:1000px}#small_poll_widget #s_p_w_body ul{display:flex;    align-items:flex-end;position:relative;transition:all .5s;padding:0;margin:0}#small_poll_widget #s_p_w_body ul li{width:350px;min-height:130px;list-style:none;padding:15px 25px;max-height:calc(100vh - 160px);overflow-y: auto}#small_poll_widget #s_p_w_body ul li .s_p_w_heading{font-size:20px;font-weight:700}#small_poll_widget #s_p_w_body ul li .s_p_w_answers{display:flex;flex-direction:column;align-items:flex-start;margin:10px 0}#small_poll_widget #s_p_w_body ul li .s_p_w_answers label{cursor:pointer;padding:5px 0;font-size:18px}#small_poll_widget #s_p_w_body ul li .s_p_w_answers input{cursor:pointer}#small_poll_widget #s_p_w_message{display:flex;justify-content:center;align-items:center;text-align:center}#small_poll_widget #s_p_w_buttons{padding:15px 25px;display:flex;justify-content:flex-end}#small_poll_widget #s_p_w_buttons button{background:#222c28;color:#fff;text-transform:uppercase;border:0;padding:8px 20px;font-size:16px;cursor:pointer;font-weight:700}#s_p_w_poll{max-height: calc(100vh - 130px);transition:all 0.3s}#s_p_w_poll ul{height:100%}</style>");
  },
  get: function get() {
    var _this = this;
  ...
  toggle: function toggle() {
    document.getElementById('small_poll_widget').classList.toggle('s_p_w_show');
  },
  togglePoll: function togglePoll() {
    document.getElementById('small_poll_widget').classList.toggle('s_p_w_loaded');
  },
  message: '',
